...
namespace Playground.CartApi.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<bool> RemoveFromCart(long cartDetailId)
        {
            try
            {
                CartDetail cartDetail = await _context.CartDetails.FirstOrDefaultAsync(c => c.ProductId == cartDetailId);
                int total = _context.CartDetails.Where(c => c.Id == cartDetail.CartHeaderId).Count();
